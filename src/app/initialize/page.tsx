...
export default function InitializePage() {
  ...
  const handleInitialize = async () => {
    ...
    // 2. Save to Supabase (in parallel or sequence)
  ...
  return (
    <div className="min-h-screen bg-black text-zinc-100 flex items-center justify-center p-6 selection:bg-[#6366f1]/30">
      ...
      <AnimatePresence mode="wait">
        {step === 1 ? (
          <motion.main 
            ...
            exit={{ opacity: 0, y: -20 }}
            className="w-full max-w-[600px] space-y-12 py-12"
          >
            {/* Header */}
                ...
                {resumeMode === 'upload' ? (
                  ...
                  >
                    ...
                    <div className="text-center">
                      <p className="text-sm text-zinc-300 font-medium">Upload Your Resume</p>
