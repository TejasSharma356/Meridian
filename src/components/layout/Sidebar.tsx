...
export default function Sidebar() {
  ...
  return (
    <aside 
      ...
      className="flex-shrink-0 flex flex-col p-6 gap-y-6 overflow-y-auto overflow-x-hidden bg-black/40 backdrop-blur-xl border-r border-white/[0.05] relative group"
    >
      ...
      <div className="flex flex-col gap-4">
        ...
        <button className="w-full py-3 px-4 bg-[#6366f1] text-white rounded-xl font-bold text-sm flex items-center justify-center gap-2 transition-transform active:scale-95 shadow-lg shadow-[#6366f1]/20">
